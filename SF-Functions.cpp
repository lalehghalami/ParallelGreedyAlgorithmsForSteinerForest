...
{
    string  strOutput_0, strOutput_1, strOutput_2, strOutput_3,strOutput_F, strOutput_pro;
    
    strOutput_0 ="Result_Alg_";
    strOutputFile.append("Result_Alg_");
    strOutputFile.append(alg);
    strOutputFile.append("");
    strOutputFile.append(algType);
    strOutputFile.append("_Ratio");    
    strOutputFile.append(ratio);
    strOutputFile.append("_Graph");
    ...
    strOutputFile.append(tokens[0]);
    strOutputFile.append("_Proc");
    strOutputFile.append(proc);
    strOutputFile.append("_Run");
